...
\begin{note}
Let $(i_0,\ldots, i_{d-1})$ be an ordered tuple such that the subgraph of $\Gamma$ on the vertices $i_0,\ldots, i_{d-1}$ is a chordless cycle, with edges of nonzero weight from $i_k$ to $i_{k+1}$, where subscripts are taken $\pmod d.$ Then, denote $$p(i_a,i_{a+1}) = s_{i_{a+1}}^{-1}s_{i_{a+2}}^{-1}\dots s_{i_{a-2}}^{-1}s_{i_{a-1}}s_{i_{a-2}}s_{i_{a-3}}\dots s_{i_{a+1}} s_{i_{a}}^{-1}.$$ Additionally, let $$t(i_a,i_{a+1}) = s_{i_a} p(i_a,i_{a+1}) p(i_a,i_{a+1})^{-1} s_{i_a}^{-1}.$$
\end{note}
...
\item[(T3)] Let $(i_0,i_1,\ldots,i_{d-1})$ be an ordered tuple such that the subgraph of $\Gamma$ on the vertices $(i_0,\ldots, i_{d-1})$ is a chordless cycle, with edges of nonzero weight from $i_k$ to $i_{k+1},$ where subscripts $k$ are taken $\pmod d.$ If $(i_0,\ldots, i_{d-1})$ is such an ordered tuple, and additionally, one of the following two conditions hold,
\begin{enumerate}
...
&= s_3s_1s_1^{-1}s_3^{-1}s_1s_2s_2^{-1}s_1^{-1} &t(2,1)\\
&= e
\end{align*}
...
&= s_1s_2^{-1}s_1^{-1}s_3^{-1}s_4s_3\underline{s_2s_1s_2s_1^{-1}} &t(2,3)\\
...
&= s_4^{-1}\underline{s_1^{-1}s_2s_1}s_4s_3 &t(3,4)\\
...
&= s_ks_2^{-1}\cdots s_{h-1}^{-1}s_hs_{h-1}\cdots s_2s_1s_k^{-1} &t(1,2)\\
