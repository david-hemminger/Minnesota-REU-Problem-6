...
In the process of writing this paper, we became aware of related results obtained independently by Grant and Marsh in \cite{GM14} and Qiu in \cite{Q14}. Using different approaches, the two papers found relations for the Artin group in the simply-laced cases. However, their relations differ from the ones used in our paper, and our approach to the problem is more combinatorial than the more topological approaches found in \cite{Q14} and \cite{GM14}.
