...
\email{...,david.hemminger@duke.edu, hpeck@millikin.edu}
\date{\today}
...
\section{Introduction \& Motivation}\todo{let's add the statement of the main theorem to the introduction - David}

\todo{use section labels rather than explicit numbers}
...
\begin{prop}\cite{BM13}[Proposition 1.4]
...
\begin{thm}\cite{BM13}[Theorem 5.4a]
