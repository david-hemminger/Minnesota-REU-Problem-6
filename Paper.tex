...
\infty &\text{otherwise}
\end{cases}$$
\item[R(3)] For every chordless oriented cycle:
...
6 &\text{if $t(l)=3$}
\end{cases}$$
\item[R(4)] For each subdiagram of $\Gamma$ of the form shown in the first column of \ref{table1}, we add the relation(s) listed in the second column.
\end{enumerate}
\end{def}
