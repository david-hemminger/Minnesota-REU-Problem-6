...
\end{note}
\begin{defn}
\cite[Beginning of section 1.2]{artin} \todo{put reference for artin, found at the bottom, in bibliography, but I don't know how to use this bibliography format. - it's just BibTex, which you'll almost certainly want to learn at some point.  Try editing References.bib, and if you have trouble feel free to ask me for help - David}
